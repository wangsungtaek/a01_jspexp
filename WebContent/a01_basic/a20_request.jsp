...
==> servlet.class
==> was(Tomcat) 메모리로딩 실행처리(out.println(html코드) 전송
==> 클라이언트에 html을 받아서 브라우저에 랜더링해서 화면을 출력.
...
ex1) loc=서울강남역&num01=25&num02=30 이 데이터를 받아서 화면에 출력하세요.
	http://localhost:7080/jspexp/a01_basic/a20_request.jsp?
 --%>
