...
<body>
	...
	<table>
		...
		if(cks!=null){
			for(Cookie c : cks){
				// 쿠키는 default로 JESSIONID를 가지고 있다.
				// 저장된 쿠키를 표기할 때는 JESSIONID를 제외한다.
		...
		if(ck!=null){
			response.sendRedirect("z02_list.jsp");
		}
		%>
		<tr><td colspan="4"><input type="submit" value="장바구니삭제"/></tr>
	</table>
	</form>
