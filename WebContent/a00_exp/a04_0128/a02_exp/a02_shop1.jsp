...
2. a01_shop1.jsp에 해당 객체 생성과 session값을 설정.
	a02_shop2.jsp로 이동, a href, location.href로 이동 처리.
3. a02_shop2.jsp에서 저장된 Product객체로 설정된 session 값 가져오기
4. a02_shop2.jsp를 호출할 때 마다.
	session지정된 Product 객체를 가져오고, 물건 갯수를 증가한 후, 다시
	session에 저장처리.
--%>
<%
...
<body>
	...
	%>
	<table>
		<tr><th>물건명</th><td><%=prod.getName() %></tr>
		<tr><th>가격</th><td><%=prod.getPrice() %></tr>
		<tr><th>갯수</th><td><%=prod.getCnt() %></tr>
	</table>
</body>
</html>